        ...
        <main className="main-content">
          <section className="hero-panel">
            <div>
              ...
              <p>Git reacts after code exists. Runway compares planned files, symbols, and behavior before agents start, blocks out-of-lane Codex patches, then verifies the final Git diff.</p>
            </div>
          ...
          <section id="collision-replay" className="replay-proof" aria-label="Provenance-backed public collision replay">
            ...
            <div className="proof-boundaries" aria-label="Evidence and model-use boundaries">
              ...
              <div><span>CODEX INTEGRATION</span><strong>{publicReplay.buildMode.builtWith} / {publicReplay.buildMode.runtime}</strong></div>
            </div>
